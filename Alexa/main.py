...
def wishMe():
    ...
    if 0 <= hour < 12:
        ...
        speak("Good Evening!")
    print("Hii, I am alexa talk something to wake up me")    
    query = takeCommand()
...
def command():
    ...
    while True:
        ...
        if ' wikipedia' in query:
            ...
            speak("What kind of exercise do lazy people do?")
            speak("Answer is Diddly-squats.")
            ...
            speak("Alexa is a voice-controlled virtual assistant. She can play audio, control your smart home, answer questions and engage ")      
            speak("your favorite services to keep you organized, informed, safe, connected and entertained. As a product of Amazon.")
            speak("she also your personal shopper.") 
            ...
            try :                  
                os.system('TASKILL/f /C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe')

            except Exception as e:
                print(e)
            speak("ok sir")
            speak("Please tell me the person")
            name = takeCommand()
            ...
            while True:
                ...
                if'Jayashree' in name:
                    ...
                    speak("Enter Time in hour")
                    hour = int(input("Enter the hour :"))
                    speak("Enter Time in minutes")
                    min = int(input("Enter the minutes :")) 
                    pywhatkit.sendwhatmsg("+918668519095",msg,hour,min,20)
                ...
                elif'do not send any message' in name: 
                    speak("ok sir")
                    speak("Not sending any message")
                    break  
